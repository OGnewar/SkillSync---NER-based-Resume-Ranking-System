...
def exResFeats (text):
    ...
    return name, email, links, phone, dob, expRoles, expYrs, expFields, eduDegs, eduFields, hards, soft, tools, products, sector, interests, langs, langProfs, certifications, totalExpMonths, expMonths
